...
def archivo_root(file_path, var1, var2, lado, cat):
   ...
   """
    ...
    FoM_var1_precorte = B_pre = B_pre2 = B_post2 = B_post = FoM_var1_postcorte = FoM_var2_precorte = FoM_var2_postcorte = S_precorte = S_postcorte = S_precorte_2 = S_postcorte_2 = 0.
    B_baja = B_alta = S_baja = S_alta = S_baja2 = B_baja2 = S_alta2 = B_alta2 = 0.
    ...
    for key in keys:
        ...
        if f"emu{cat}" in dir_name:  # Filtra según la categoría que nos interesa (_tDM, _ttDM, ...)
            ...
            S_pre = - S_corte + S_baja
            B_pre = - B_corte + B_baja
            S_post = - S_alta + S_corte
            B_post = - B_alta + B_corte

            FoM_pre = S_pre / math.sqrt(B_pre) if B_pre > 0 else 0.0
            FoM_post = S_post / math.sqrt(B_post) if B_post > 0 else 0.0

            FoM_corregido = math.sqrt(FoM_pre**2 + FoM_post**2)

            print(f"{var1}: El valor de FoM antes del corte es {FoM_pre} y despúes del corte es {FoM_post}, siendo la suma cuadrática: {FoM_corregido}")
            ...
            # TODO: CORRECCIÓN FOM 2 REGIONES
            ...
            print(f"{var2}: El valor de FoM antes del corte es {FoM_pre} y despúes del corte es {FoM_post}, siendo la suma cuadrática: {FoM_corregido}")
            ...
            FoM_var2_total = math.sqrt(FoM_var2_precorte**2 + FoM_var2_postcorte**2)
...
if __name__ == "__main__":
    file_path = "./rootfiles__Full2018_v7/mkShapes__Full2018_v7.root"
    var1 = "mpmet"
    var2 = "mtw2"
    lado = "dcha"
