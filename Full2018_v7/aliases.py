"""
Script utilizado para definir los aliases utilizados en el marco de trabajo.

Código adaptado de : https://github.com/piedraj/HEP/blob/main/Full2018_v7/aliases.py
"""
...
"""
aliases['sigdnn'] = {
        'linesToAdd': [f'#include "/afs/cern.ch/user/n/nbabioel/mkShapesRDF/HEP/Full2018_v7/evaluate_DNN.cc"'],
        'class': 'evaluate_dnn',
        #'args': f'mll, ptll, dphill, drll, mjj,detajj, dphillmet, mth, mTi, ht, PuppiMET_pt, Lepton_pt[0], Lepton_pt[1], Lepton_eta[0], Lepton_eta[1], CleanJet_pt[0], CleanJet_pt[1], CleanJet_eta[0], CleanJet_eta[1]'
        'args': f'mpmet, mtw2, dphill, dphillmet, drll'
}
"""

aliases['MllT2'] = { # M_T (pag 40)
    'expr': 'sqrt(2 * Lepton_pt[0] * PuppiMET_pt * (1 - cos(Lepton_phi[0] - PuppiMET_phi)))'
}
...
bWP   = '0.4184' # Loose --> 0.1241; Medium --> 0.4184; Tight --> 0.7527
