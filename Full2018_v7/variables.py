"""
Script donde se definen las variables físicas que se estudiarán.

Código adapatado de: https://github.com/piedraj/HEP/blob/main/Full2018_v7/variables.py
"""
...
variables['sigdnn'] = {
      ...
      'range' : (12, -0.1, 1.1),
      'xaxis' : 'DNN discriminant ttDM vs tt',
      'fold'  : 3,
}
"""
variables['mT2'] = {
