...
// Wed Jan 29 18:33:18 2025 by ROOT version 6.30/02
// from TTree Events/Events
// found on file: root://eoscms.cern.ch//eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9/nanoLatino_TTJets__part52.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenJet;
   Float_t         GenJet_eta[31];   //[nGenJet]
   Float_t         GenJet_mass[31];   //[nGenJet]
   Float_t         GenJet_phi[31];   //[nGenJet]
   Float_t         GenJet_pt[31];   //[nGenJet]
   UInt_t          nGenPart;
   ...
   Int_t           IsoTrack_charge[13];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[13];   //[nIsoTrack]
   ...
   Int_t           GenJet_partonFlavour[31];   //[nGenJet]
   UChar_t         GenJet_hadronFlavour[31];   //[nGenJet]
   Float_t         GenVtx_t0;
   ...
   Int_t           Muon_genPartIdx[22];   //[nMuon]
   UChar_t         Muon_genPartFlav[22];   //[nMuon]
   ...
   Int_t           Lepton_electronIdx[4];   //[nLepton]
   Int_t           Lepton_muonIdx[4];   //[nLepton]
   Float_t         Lepton_pt[4];   //[nLepton]
   Float_t         Lepton_eta[4];   //[nLepton]
   Float_t         Lepton_phi[4];   //[nLepton]
   UInt_t          nVetoLepton;
   Int_t           VetoLepton_pdgId[11];   //[nVetoLepton]
   Int_t           VetoLepton_electronIdx[11];   //[nVetoLepton]
   Int_t           VetoLepton_muonIdx[11];   //[nVetoLepton]
   Float_t         VetoLepton_pt[11];   //[nVetoLepton]
   Float_t         VetoLepton_eta[11];   //[nVetoLepton]
   Float_t         VetoLepton_phi[11];   //[nVetoLepton]
   UInt_t          nCleanJet;
   ...
   Int_t           Lepton_isLoose[4];   //[nLepton]
   Int_t           Lepton_isVeto[4];   //[nLepton]
   Float_t         dmZll_veto;
   Int_t           Lepton_isTightElectron_mvaFall17V2Iso_WP90_tthmva_70[4];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70[4];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17V2Iso_WP90_SS[4];   //[nLepton]
   Int_t           Lepton_isTightElectron_mvaFall17V2Iso_WP90[4];   //[nLepton]
   Int_t           Lepton_isTightMuon_cut_Tight_HWWW_tthmva_80[4];   //[nLepton]
   Int_t           Lepton_isTightMuon_cut_Tight_HWWW[4];   //[nLepton]
   UInt_t          nCleanFatJet;
   ...
   UInt_t          nLeptonGen;
   Int_t           LeptonGen_MotherPID[24];   //[nLeptonGen]
   Int_t           LeptonGen_MotherStatus[24];   //[nLeptonGen]
   Int_t           LeptonGen_pdgId[24];   //[nLeptonGen]
   Int_t           LeptonGen_status[24];   //[nLeptonGen]
   Float_t         LeptonGen_eta[24];   //[nLeptonGen]
   Float_t         LeptonGen_phi[24];   //[nLeptonGen]
   Float_t         LeptonGen_pt[24];   //[nLeptonGen]
   Float_t         LeptonGen_mass[24];   //[nLeptonGen]
   Bool_t          LeptonGen_fromHardProcess[24];   //[nLeptonGen]
   Bool_t          LeptonGen_isDirectHadronDecayProduct[24];   //[nLeptonGen]
   Bool_t          LeptonGen_isDirectPromptTauDecayProduct[24];   //[nLeptonGen]
   Bool_t          LeptonGen_isPrompt[24];   //[nLeptonGen]
   Bool_t          LeptonGen_isTauDecayProduct[24];   //[nLeptonGen]
   UInt_t          nNeutrinoGen;
   Int_t           NeutrinoGen_MotherPID[16];   //[nNeutrinoGen]
   Int_t           NeutrinoGen_MotherStatus[16];   //[nNeutrinoGen]
   Int_t           NeutrinoGen_pdgId[16];   //[nNeutrinoGen]
   Int_t           NeutrinoGen_status[16];   //[nNeutrinoGen]
   Float_t         NeutrinoGen_eta[16];   //[nNeutrinoGen]
   Float_t         NeutrinoGen_phi[16];   //[nNeutrinoGen]
   Float_t         NeutrinoGen_pt[16];   //[nNeutrinoGen]
   Float_t         NeutrinoGen_mass[16];   //[nNeutrinoGen]
   Bool_t          NeutrinoGen_fromHardProcess[16];   //[nNeutrinoGen]
   Bool_t          NeutrinoGen_isDirectHadronDecayProduct[16];   //[nNeutrinoGen]
   Bool_t          NeutrinoGen_isDirectPromptTauDecayProduct[16];   //[nNeutrinoGen]
   Bool_t          NeutrinoGen_isPrompt[16];   //[nNeutrinoGen]
   Bool_t          NeutrinoGen_isTauDecayProduct[16];   //[nNeutrinoGen]
   UInt_t          nPhotonGen;
   Int_t           PhotonGen_MotherPID[24];   //[nPhotonGen]
   Int_t           PhotonGen_MotherStatus[24];   //[nPhotonGen]
   Int_t           PhotonGen_pdgId[24];   //[nPhotonGen]
   Int_t           PhotonGen_status[24];   //[nPhotonGen]
   Float_t         PhotonGen_eta[24];   //[nPhotonGen]
   Float_t         PhotonGen_phi[24];   //[nPhotonGen]
   Float_t         PhotonGen_pt[24];   //[nPhotonGen]
   Float_t         PhotonGen_mass[24];   //[nPhotonGen]
   Bool_t          PhotonGen_fromHardProcess[24];   //[nPhotonGen]
   Bool_t          PhotonGen_isDirectHadronDecayProduct[24];   //[nPhotonGen]
   Bool_t          PhotonGen_isDirectPromptTauDecayProduct[24];   //[nPhotonGen]
   Bool_t          PhotonGen_isPrompt[24];   //[nPhotonGen]
   Bool_t          PhotonGen_isTauDecayProduct[24];   //[nPhotonGen]
   Float_t         gen_ptllmet;
   Float_t         gen_ptll;
   Float_t         gen_mll;
   ...
   Float_t         lhe_mWp;
   Float_t         lhe_mWm;
   Bool_t          Lepton_genmatched[4];   //[nLepton]
   Bool_t          Lepton_promptgenmatched[4];   //[nLepton]
   Float_t         higgsGenPt;
   Float_t         higgsGenEta;
   Float_t         higgsGenPhi;
   ...
   Int_t           DressedLepton_pdgId[24];   //[nDressedLepton]
   Float_t         DressedLepton_pt[24];   //[nDressedLepton]
   Float_t         DressedLepton_eta[24];   //[nDressedLepton]
   Float_t         DressedLepton_phi[24];   //[nDressedLepton]
   Float_t         DressedLepton_mass[24];   //[nDressedLepton]
   Float_t         baseW;
   Float_t         Xsec;
   Float_t         CleanJet_mass[20];   //[nCleanJet]
   Float_t         CleanJet_corr_JER[20];   //[nCleanJet]
   Int_t           CleanJet_cleanJetIdx_preJER[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER0Up[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER0Up[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER1Up[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER1Up[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER2Up[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER2Up[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER3Up[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER3Up[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER4Up[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER4Up[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER5Up[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER5Up[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER0Down[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER0Down[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER1Down[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER1Down[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER2Down[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER2Down[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER3Down[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER3Down[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER4Down[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER4Down[20];   //[nCleanJet]
   Float_t         CleanJet_pt_JER5Down[20];   //[nCleanJet]
   Float_t         CleanJet_mass_JER5Down[20];   //[nCleanJet]
   ...
   Int_t           FatJet_fatJetIdx_preJER[6];   //[nFatJet]
   Float_t         FatJet_pt_JER0Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JER0Up[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER0Up[6];   //[nFatJet]
   Float_t         FatJet_pt_JER1Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JER1Up[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER1Up[6];   //[nFatJet]
   Float_t         FatJet_pt_JER2Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JER2Up[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER2Up[6];   //[nFatJet]
   Float_t         FatJet_pt_JER3Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JER3Up[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER3Up[6];   //[nFatJet]
   Float_t         FatJet_pt_JER4Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JER4Up[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER4Up[6];   //[nFatJet]
   Float_t         FatJet_pt_JER5Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JER5Up[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER5Up[6];   //[nFatJet]
   Float_t         FatJet_mass_JMRUp[6];   //[nFatJet]
   Float_t         FatJet_mass_JMSUp[6];   //[nFatJet]
   Float_t         FatJet_pt_JER0Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JER0Down[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER0Down[6];   //[nFatJet]
   Float_t         FatJet_pt_JER1Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JER1Down[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER1Down[6];   //[nFatJet]
   Float_t         FatJet_pt_JER2Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JER2Down[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER2Down[6];   //[nFatJet]
   Float_t         FatJet_pt_JER3Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JER3Down[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER3Down[6];   //[nFatJet]
   Float_t         FatJet_pt_JER4Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JER4Down[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER4Down[6];   //[nFatJet]
   Float_t         FatJet_pt_JER5Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JER5Down[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_JER5Down[6];   //[nFatJet]
   Float_t         FatJet_mass_JMRDown[6];   //[nFatJet]
   Float_t         FatJet_mass_JMSDown[6];   //[nFatJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesBBEC1_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesRelativeBal[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesAbsolute_2018[30];   //[nJet]
   ...
   Float_t         Jet_btagSF_deepcsv_shape_up_jesAbsolute_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_hf[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jes[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesRelativeSample_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesRelativeBal[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_lf[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_lf[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesFlavorQCD[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesRelativeSample_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesAbsolute[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_cferr2[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_cferr1[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesBBEC1_2018[30];   //[nJet]
   ...
   Float_t         Jet_btagSF_deepcsv_shape_up_jesHF[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesBBEC1[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesHF[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesEC2[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesHF_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesBBEC1[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesFlavorQCD[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesAbsolute[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_cferr1[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_cferr2[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jesEC2_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesEC2_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesHF_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_up_jesEC2[30];   //[nJet]
   Float_t         Jet_btagSF_deepcsv_shape_down_jes[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesBBEC1_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesRelativeBal[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesAbsolute_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_lfstats1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_lfstats2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_hfstats1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_hfstats2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_lfstats2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_lfstats1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesAbsolute_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_hf[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jes[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesRelativeSample_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesRelativeBal[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_lf[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_lf[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesFlavorQCD[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesRelativeSample_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesAbsolute[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_cferr2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_cferr1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesBBEC1_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_hf[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_hfstats2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_hfstats1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesHF[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesBBEC1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesHF[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesEC2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesHF_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesBBEC1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesFlavorQCD[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesAbsolute[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_cferr1[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_cferr2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jesEC2_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesEC2_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesHF_2018[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_up_jesEC2[30];   //[nJet]
   Float_t         Jet_btagSF_deepjet_shape_down_jes[30];   //[nJet]
   Float_t         Jet_PUIDSF_loose[30];   //[nJet]
   Float_t         Jet_PUIDSF_loose_up[30];   //[nJet]
   Float_t         Jet_PUIDSF_loose_down[30];   //[nJet]
   Float_t         puidWeight;
   Float_t         puidWeightUp;
   Float_t         puidWeightDown;
   Float_t         Lepton_rochesterSF[4];   //[nLepton]
   ...
   Float_t         Lepton_RecoSF[4];   //[nLepton]
   Float_t         Lepton_RecoSF_Up[4];   //[nLepton]
   Float_t         Lepton_RecoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Syst[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Syst[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Syst[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Syst[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_IdIsoSF[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_IdIsoSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_IdIsoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_IdIsoSF_Syst[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_TotSF[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_TotSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_tthmva_80_TotSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_IdIsoSF[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_IdIsoSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_IdIsoSF_Down[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_IdIsoSF_Syst[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_TotSF[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_TotSF_Up[4];   //[nLepton]
   Float_t         Lepton_tightMuon_cut_Tight_HWWW_TotSF_Down[4];   //[nLepton]
   Float_t         puWeight_UL2018;
   Float_t         puWeight;
   Float_t         puWeight_UL2018Up;
   Float_t         puWeightUp;
   Float_t         puWeight_UL2018Down;
   ...
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do;
   Float_t         SFweight4l;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90__Up;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up;
   Float_t         LepCut4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Up;
   ...
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90__Do;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Do;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepCut4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90__Up;
   Float_t         LepCut4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF3l__mu_cut_Tight_HWWW_tthmva_80__Up;
   Float_t         LepSF3l__mu_cut_Tight_HWWW__Up;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Do;
   ...
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Up;
   Float_t         LepCut3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepCut4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90__Do;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up;
   ...
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Do;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;
   Float_t         LepCut2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Up;
   Float_t         LepSF4l__mu_cut_Tight_HWWW__Do;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do;
   ...
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;
   Float_t         LepCut3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepCut2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;
   Float_t         LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         METFilter_MC;
   Float_t         LepSF3l__mu_cut_Tight_HWWW__Do;
   Float_t         GenLepMatch2l;
   Float_t         LepSF2l__mu_cut_Tight_HWWW__Up;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90__Do;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepCut3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         SFweight2l;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF2l__mu_cut_Tight_HWWW__Do;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do;
   Float_t         LepSF2l__mu_cut_Tight_HWWW_tthmva_80__Do;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90__Up;
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up;
   ...
   Float_t         LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepCut2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   Float_t         LepSF4l__mu_cut_Tight_HWWW__Up;
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;
   Float_t         XSWeight;
   ...
   Float_t         LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;
   ...
   TBranch        *b_CleanJet_cleanJetIdx_preJER;   //!
   TBranch        *b_CleanJet_pt_JER0Up;   //!
   TBranch        *b_CleanJet_mass_JER0Up;   //!
   TBranch        *b_CleanJet_pt_JER1Up;   //!
   TBranch        *b_CleanJet_mass_JER1Up;   //!
   TBranch        *b_CleanJet_pt_JER2Up;   //!
   TBranch        *b_CleanJet_mass_JER2Up;   //!
   TBranch        *b_CleanJet_pt_JER3Up;   //!
   TBranch        *b_CleanJet_mass_JER3Up;   //!
   TBranch        *b_CleanJet_pt_JER4Up;   //!
   TBranch        *b_CleanJet_mass_JER4Up;   //!
   TBranch        *b_CleanJet_pt_JER5Up;   //!
   TBranch        *b_CleanJet_mass_JER5Up;   //!
   TBranch        *b_CleanJet_pt_JER0Down;   //!
   TBranch        *b_CleanJet_mass_JER0Down;   //!
   TBranch        *b_CleanJet_pt_JER1Down;   //!
   TBranch        *b_CleanJet_mass_JER1Down;   //!
   TBranch        *b_CleanJet_pt_JER2Down;   //!
   TBranch        *b_CleanJet_mass_JER2Down;   //!
   TBranch        *b_CleanJet_pt_JER3Down;   //!
   TBranch        *b_CleanJet_mass_JER3Down;   //!
   TBranch        *b_CleanJet_pt_JER4Down;   //!
   TBranch        *b_CleanJet_mass_JER4Down;   //!
   TBranch        *b_CleanJet_pt_JER5Down;   //!
   TBranch        *b_CleanJet_mass_JER5Down;   //!
   TBranch        *b_FatJet_corr_JER;   //!
   TBranch        *b_FatJet_corr_JMS;   //!
   TBranch        *b_FatJet_corr_JMR;   //!
   TBranch        *b_FatJet_msoftdrop_raw;   //!
   TBranch        *b_FatJet_fatJetIdx_preJER;   //!
   TBranch        *b_FatJet_pt_JER0Up;   //!
   TBranch        *b_FatJet_mass_JER0Up;   //!
   TBranch        *b_FatJet_msoftdrop_JER0Up;   //!
   TBranch        *b_FatJet_pt_JER1Up;   //!
   TBranch        *b_FatJet_mass_JER1Up;   //!
   TBranch        *b_FatJet_msoftdrop_JER1Up;   //!
   TBranch        *b_FatJet_pt_JER2Up;   //!
   TBranch        *b_FatJet_mass_JER2Up;   //!
   TBranch        *b_FatJet_msoftdrop_JER2Up;   //!
   TBranch        *b_FatJet_pt_JER3Up;   //!
   TBranch        *b_FatJet_mass_JER3Up;   //!
   TBranch        *b_FatJet_msoftdrop_JER3Up;   //!
   TBranch        *b_FatJet_pt_JER4Up;   //!
   TBranch        *b_FatJet_mass_JER4Up;   //!
   TBranch        *b_FatJet_msoftdrop_JER4Up;   //!
   TBranch        *b_FatJet_pt_JER5Up;   //!
   TBranch        *b_FatJet_mass_JER5Up;   //!
   TBranch        *b_FatJet_msoftdrop_JER5Up;   //!
   TBranch        *b_FatJet_mass_JMRUp;   //!
   TBranch        *b_FatJet_mass_JMSUp;   //!
   TBranch        *b_FatJet_pt_JER0Down;   //!
   TBranch        *b_FatJet_mass_JER0Down;   //!
   TBranch        *b_FatJet_msoftdrop_JER0Down;   //!
   TBranch        *b_FatJet_pt_JER1Down;   //!
   TBranch        *b_FatJet_mass_JER1Down;   //!
   TBranch        *b_FatJet_msoftdrop_JER1Down;   //!
   TBranch        *b_FatJet_pt_JER2Down;   //!
   TBranch        *b_FatJet_mass_JER2Down;   //!
   TBranch        *b_FatJet_msoftdrop_JER2Down;   //!
   TBranch        *b_FatJet_pt_JER3Down;   //!
   TBranch        *b_FatJet_mass_JER3Down;   //!
   TBranch        *b_FatJet_msoftdrop_JER3Down;   //!
   TBranch        *b_FatJet_pt_JER4Down;   //!
   TBranch        *b_FatJet_mass_JER4Down;   //!
   TBranch        *b_FatJet_msoftdrop_JER4Down;   //!
   TBranch        *b_FatJet_pt_JER5Down;   //!
   TBranch        *b_FatJet_mass_JER5Down;   //!
   TBranch        *b_FatJet_msoftdrop_JER5Down;   //!
   TBranch        *b_FatJet_mass_JMRDown;   //!
   TBranch        *b_FatJet_mass_JMSDown;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesBBEC1_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesRelativeBal;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesAbsolute_2018;   //!
   ...
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesAbsolute_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_hf;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jes;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesRelativeSample_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesRelativeBal;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_lf;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_lf;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesFlavorQCD;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesRelativeSample_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesAbsolute;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_cferr2;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_cferr1;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesBBEC1_2018;   //!
   ...
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesHF;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesBBEC1;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesHF;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesEC2;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesHF_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesBBEC1;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesFlavorQCD;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesAbsolute;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_cferr1;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_cferr2;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_down_jesEC2_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesEC2_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesHF_2018;   //!
   TBranch        *b_Jet_btagSF_deepcsv_shape_up_jesEC2;   //!
   ...
   TBranch        *b_puidWeightUp;   //!
   TBranch        *b_puidWeightDown;   //!
   ...
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Syst;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Syst;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Syst;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Down;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Syst;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Up;   //!
   TBranch        *b_Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Down;   //!
   ...
   TBranch        *b_puWeight_UL2018;   //!
   TBranch        *b_puWeight;   //!
   TBranch        *b_puWeight_UL2018Up;   //!
   TBranch        *b_puWeightUp;   //!
   TBranch        *b_puWeight_UL2018Down;   //!
   ...
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do;   //!
   TBranch        *b_SFweight4l;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90__Up;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up;   //!
   TBranch        *b_LepCut4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Up;   //!
   ...
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90__Do;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Do;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepCut4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90__Up;   //!
   TBranch        *b_LepCut4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF3l__mu_cut_Tight_HWWW_tthmva_80__Up;   //!
   TBranch        *b_LepSF3l__mu_cut_Tight_HWWW__Up;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Do;   //!
   ...
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Up;   //!
   TBranch        *b_LepCut3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepCut4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90__Do;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up;   //!
   ...
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Do;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepCut2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Up;   //!
   TBranch        *b_LepSF4l__mu_cut_Tight_HWWW__Do;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do;   //!
   ...
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepCut3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepCut2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   ...
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90__Do;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepCut3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_SFweight2l;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;   //!
   TBranch        *b_LepSF2l__mu_cut_Tight_HWWW__Do;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do;   //!
   TBranch        *b_LepSF2l__mu_cut_Tight_HWWW_tthmva_80__Do;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up;   //!
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90__Up;   //!
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up;   //!
   ...
   TBranch        *b_LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80;   //!
   ...
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW;   //!
   TBranch        *b_XSWeight;   //!
   ...
   TBranch        *b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80;   //!
   ...
   TBranch        *b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms.cern.ch//eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9/nanoLatino_TTJets__part52.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms.cern.ch//eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9/nanoLatino_TTJets__part52.root");
      }
...
void TreeContent::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("CleanJet_cleanJetIdx_preJER", CleanJet_cleanJetIdx_preJER, &b_CleanJet_cleanJetIdx_preJER);
   fChain->SetBranchAddress("CleanJet_pt_JER0Up", CleanJet_pt_JER0Up, &b_CleanJet_pt_JER0Up);
   fChain->SetBranchAddress("CleanJet_mass_JER0Up", CleanJet_mass_JER0Up, &b_CleanJet_mass_JER0Up);
   fChain->SetBranchAddress("CleanJet_pt_JER1Up", CleanJet_pt_JER1Up, &b_CleanJet_pt_JER1Up);
   fChain->SetBranchAddress("CleanJet_mass_JER1Up", CleanJet_mass_JER1Up, &b_CleanJet_mass_JER1Up);
   fChain->SetBranchAddress("CleanJet_pt_JER2Up", CleanJet_pt_JER2Up, &b_CleanJet_pt_JER2Up);
   fChain->SetBranchAddress("CleanJet_mass_JER2Up", CleanJet_mass_JER2Up, &b_CleanJet_mass_JER2Up);
   fChain->SetBranchAddress("CleanJet_pt_JER3Up", CleanJet_pt_JER3Up, &b_CleanJet_pt_JER3Up);
   fChain->SetBranchAddress("CleanJet_mass_JER3Up", CleanJet_mass_JER3Up, &b_CleanJet_mass_JER3Up);
   fChain->SetBranchAddress("CleanJet_pt_JER4Up", CleanJet_pt_JER4Up, &b_CleanJet_pt_JER4Up);
   fChain->SetBranchAddress("CleanJet_mass_JER4Up", CleanJet_mass_JER4Up, &b_CleanJet_mass_JER4Up);
   fChain->SetBranchAddress("CleanJet_pt_JER5Up", CleanJet_pt_JER5Up, &b_CleanJet_pt_JER5Up);
   fChain->SetBranchAddress("CleanJet_mass_JER5Up", CleanJet_mass_JER5Up, &b_CleanJet_mass_JER5Up);
   fChain->SetBranchAddress("CleanJet_pt_JER0Down", CleanJet_pt_JER0Down, &b_CleanJet_pt_JER0Down);
   fChain->SetBranchAddress("CleanJet_mass_JER0Down", CleanJet_mass_JER0Down, &b_CleanJet_mass_JER0Down);
   fChain->SetBranchAddress("CleanJet_pt_JER1Down", CleanJet_pt_JER1Down, &b_CleanJet_pt_JER1Down);
   fChain->SetBranchAddress("CleanJet_mass_JER1Down", CleanJet_mass_JER1Down, &b_CleanJet_mass_JER1Down);
   fChain->SetBranchAddress("CleanJet_pt_JER2Down", CleanJet_pt_JER2Down, &b_CleanJet_pt_JER2Down);
   fChain->SetBranchAddress("CleanJet_mass_JER2Down", CleanJet_mass_JER2Down, &b_CleanJet_mass_JER2Down);
   fChain->SetBranchAddress("CleanJet_pt_JER3Down", CleanJet_pt_JER3Down, &b_CleanJet_pt_JER3Down);
   fChain->SetBranchAddress("CleanJet_mass_JER3Down", CleanJet_mass_JER3Down, &b_CleanJet_mass_JER3Down);
   fChain->SetBranchAddress("CleanJet_pt_JER4Down", CleanJet_pt_JER4Down, &b_CleanJet_pt_JER4Down);
   fChain->SetBranchAddress("CleanJet_mass_JER4Down", CleanJet_mass_JER4Down, &b_CleanJet_mass_JER4Down);
   fChain->SetBranchAddress("CleanJet_pt_JER5Down", CleanJet_pt_JER5Down, &b_CleanJet_pt_JER5Down);
   fChain->SetBranchAddress("CleanJet_mass_JER5Down", CleanJet_mass_JER5Down, &b_CleanJet_mass_JER5Down);
   ...
   fChain->SetBranchAddress("FatJet_fatJetIdx_preJER", FatJet_fatJetIdx_preJER, &b_FatJet_fatJetIdx_preJER);
   fChain->SetBranchAddress("FatJet_pt_JER0Up", FatJet_pt_JER0Up, &b_FatJet_pt_JER0Up);
   fChain->SetBranchAddress("FatJet_mass_JER0Up", FatJet_mass_JER0Up, &b_FatJet_mass_JER0Up);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER0Up", FatJet_msoftdrop_JER0Up, &b_FatJet_msoftdrop_JER0Up);
   fChain->SetBranchAddress("FatJet_pt_JER1Up", FatJet_pt_JER1Up, &b_FatJet_pt_JER1Up);
   fChain->SetBranchAddress("FatJet_mass_JER1Up", FatJet_mass_JER1Up, &b_FatJet_mass_JER1Up);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER1Up", FatJet_msoftdrop_JER1Up, &b_FatJet_msoftdrop_JER1Up);
   fChain->SetBranchAddress("FatJet_pt_JER2Up", FatJet_pt_JER2Up, &b_FatJet_pt_JER2Up);
   fChain->SetBranchAddress("FatJet_mass_JER2Up", FatJet_mass_JER2Up, &b_FatJet_mass_JER2Up);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER2Up", FatJet_msoftdrop_JER2Up, &b_FatJet_msoftdrop_JER2Up);
   fChain->SetBranchAddress("FatJet_pt_JER3Up", FatJet_pt_JER3Up, &b_FatJet_pt_JER3Up);
   fChain->SetBranchAddress("FatJet_mass_JER3Up", FatJet_mass_JER3Up, &b_FatJet_mass_JER3Up);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER3Up", FatJet_msoftdrop_JER3Up, &b_FatJet_msoftdrop_JER3Up);
   fChain->SetBranchAddress("FatJet_pt_JER4Up", FatJet_pt_JER4Up, &b_FatJet_pt_JER4Up);
   fChain->SetBranchAddress("FatJet_mass_JER4Up", FatJet_mass_JER4Up, &b_FatJet_mass_JER4Up);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER4Up", FatJet_msoftdrop_JER4Up, &b_FatJet_msoftdrop_JER4Up);
   fChain->SetBranchAddress("FatJet_pt_JER5Up", FatJet_pt_JER5Up, &b_FatJet_pt_JER5Up);
   fChain->SetBranchAddress("FatJet_mass_JER5Up", FatJet_mass_JER5Up, &b_FatJet_mass_JER5Up);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER5Up", FatJet_msoftdrop_JER5Up, &b_FatJet_msoftdrop_JER5Up);
   ...
   fChain->SetBranchAddress("FatJet_pt_JER0Down", FatJet_pt_JER0Down, &b_FatJet_pt_JER0Down);
   fChain->SetBranchAddress("FatJet_mass_JER0Down", FatJet_mass_JER0Down, &b_FatJet_mass_JER0Down);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER0Down", FatJet_msoftdrop_JER0Down, &b_FatJet_msoftdrop_JER0Down);
   fChain->SetBranchAddress("FatJet_pt_JER1Down", FatJet_pt_JER1Down, &b_FatJet_pt_JER1Down);
   fChain->SetBranchAddress("FatJet_mass_JER1Down", FatJet_mass_JER1Down, &b_FatJet_mass_JER1Down);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER1Down", FatJet_msoftdrop_JER1Down, &b_FatJet_msoftdrop_JER1Down);
   fChain->SetBranchAddress("FatJet_pt_JER2Down", FatJet_pt_JER2Down, &b_FatJet_pt_JER2Down);
   fChain->SetBranchAddress("FatJet_mass_JER2Down", FatJet_mass_JER2Down, &b_FatJet_mass_JER2Down);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER2Down", FatJet_msoftdrop_JER2Down, &b_FatJet_msoftdrop_JER2Down);
   fChain->SetBranchAddress("FatJet_pt_JER3Down", FatJet_pt_JER3Down, &b_FatJet_pt_JER3Down);
   fChain->SetBranchAddress("FatJet_mass_JER3Down", FatJet_mass_JER3Down, &b_FatJet_mass_JER3Down);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER3Down", FatJet_msoftdrop_JER3Down, &b_FatJet_msoftdrop_JER3Down);
   fChain->SetBranchAddress("FatJet_pt_JER4Down", FatJet_pt_JER4Down, &b_FatJet_pt_JER4Down);
   fChain->SetBranchAddress("FatJet_mass_JER4Down", FatJet_mass_JER4Down, &b_FatJet_mass_JER4Down);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER4Down", FatJet_msoftdrop_JER4Down, &b_FatJet_msoftdrop_JER4Down);
   fChain->SetBranchAddress("FatJet_pt_JER5Down", FatJet_pt_JER5Down, &b_FatJet_pt_JER5Down);
   fChain->SetBranchAddress("FatJet_mass_JER5Down", FatJet_mass_JER5Down, &b_FatJet_mass_JER5Down);
   fChain->SetBranchAddress("FatJet_msoftdrop_JER5Down", FatJet_msoftdrop_JER5Down, &b_FatJet_msoftdrop_JER5Down);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesBBEC1_2018", Jet_btagSF_deepcsv_shape_down_jesBBEC1_2018, &b_Jet_btagSF_deepcsv_shape_down_jesBBEC1_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesRelativeBal", Jet_btagSF_deepcsv_shape_up_jesRelativeBal, &b_Jet_btagSF_deepcsv_shape_up_jesRelativeBal);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesAbsolute_2018", Jet_btagSF_deepcsv_shape_down_jesAbsolute_2018, &b_Jet_btagSF_deepcsv_shape_down_jesAbsolute_2018);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesAbsolute_2018", Jet_btagSF_deepcsv_shape_up_jesAbsolute_2018, &b_Jet_btagSF_deepcsv_shape_up_jesAbsolute_2018);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesRelativeSample_2018", Jet_btagSF_deepcsv_shape_down_jesRelativeSample_2018, &b_Jet_btagSF_deepcsv_shape_down_jesRelativeSample_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesRelativeBal", Jet_btagSF_deepcsv_shape_down_jesRelativeBal, &b_Jet_btagSF_deepcsv_shape_down_jesRelativeBal);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesFlavorQCD", Jet_btagSF_deepcsv_shape_up_jesFlavorQCD, &b_Jet_btagSF_deepcsv_shape_up_jesFlavorQCD);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesRelativeSample_2018", Jet_btagSF_deepcsv_shape_up_jesRelativeSample_2018, &b_Jet_btagSF_deepcsv_shape_up_jesRelativeSample_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesAbsolute", Jet_btagSF_deepcsv_shape_down_jesAbsolute, &b_Jet_btagSF_deepcsv_shape_down_jesAbsolute);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesBBEC1_2018", Jet_btagSF_deepcsv_shape_up_jesBBEC1_2018, &b_Jet_btagSF_deepcsv_shape_up_jesBBEC1_2018);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesHF", Jet_btagSF_deepcsv_shape_up_jesHF, &b_Jet_btagSF_deepcsv_shape_up_jesHF);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesBBEC1", Jet_btagSF_deepcsv_shape_down_jesBBEC1, &b_Jet_btagSF_deepcsv_shape_down_jesBBEC1);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesHF", Jet_btagSF_deepcsv_shape_down_jesHF, &b_Jet_btagSF_deepcsv_shape_down_jesHF);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesEC2", Jet_btagSF_deepcsv_shape_down_jesEC2, &b_Jet_btagSF_deepcsv_shape_down_jesEC2);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesHF_2018", Jet_btagSF_deepcsv_shape_down_jesHF_2018, &b_Jet_btagSF_deepcsv_shape_down_jesHF_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesBBEC1", Jet_btagSF_deepcsv_shape_up_jesBBEC1, &b_Jet_btagSF_deepcsv_shape_up_jesBBEC1);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesFlavorQCD", Jet_btagSF_deepcsv_shape_down_jesFlavorQCD, &b_Jet_btagSF_deepcsv_shape_down_jesFlavorQCD);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesAbsolute", Jet_btagSF_deepcsv_shape_up_jesAbsolute, &b_Jet_btagSF_deepcsv_shape_up_jesAbsolute);
   ...
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_down_jesEC2_2018", Jet_btagSF_deepcsv_shape_down_jesEC2_2018, &b_Jet_btagSF_deepcsv_shape_down_jesEC2_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape", Jet_btagSF_deepcsv_shape, &b_Jet_btagSF_deepcsv_shape);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesEC2_2018", Jet_btagSF_deepcsv_shape_up_jesEC2_2018, &b_Jet_btagSF_deepcsv_shape_up_jesEC2_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesHF_2018", Jet_btagSF_deepcsv_shape_up_jesHF_2018, &b_Jet_btagSF_deepcsv_shape_up_jesHF_2018);
   fChain->SetBranchAddress("Jet_btagSF_deepcsv_shape_up_jesEC2", Jet_btagSF_deepcsv_shape_up_jesEC2, &b_Jet_btagSF_deepcsv_shape_up_jesEC2);
   ...
   fChain->SetBranchAddress("puidWeightUp", &puidWeightUp, &b_puidWeightUp);
   fChain->SetBranchAddress("puidWeightDown", &puidWeightDown, &b_puidWeightDown);
   ...
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Syst", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Syst, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_IdIsoSF_Syst);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_tthmva_70_TotSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Syst", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Syst, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_IdIsoSF_Syst);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_tthmva_70_TotSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Syst", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Syst, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_IdIsoSF_Syst);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_SS_TotSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Down);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Syst", Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Syst, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_IdIsoSF_Syst);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF", Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Up", Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Up, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Up);
   fChain->SetBranchAddress("Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Down", Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Down, &b_Lepton_tightElectron_mvaFall17V2Iso_WP90_TotSF_Down);
   ...
   fChain->SetBranchAddress("puWeight_UL2018", &puWeight_UL2018, &b_puWeight_UL2018);
   fChain->SetBranchAddress("puWeight", &puWeight, &b_puWeight);
   fChain->SetBranchAddress("puWeight_UL2018Up", &puWeight_UL2018Up, &b_puWeight_UL2018Up);
   fChain->SetBranchAddress("puWeightUp", &puWeightUp, &b_puWeightUp);
   fChain->SetBranchAddress("puWeight_UL2018Down", &puWeight_UL2018Down, &b_puWeight_UL2018Down);
   ...
   fChain->SetBranchAddress("AZH_mA_minus_mH", &AZH_mA_minus_mH, &b_AZH_mA_minus_mH);
   ...
   fChain->SetBranchAddress("AZH_Amass", &AZH_Amass, &b_AZH_Amass);
   ...
   fChain->SetBranchAddress("AZH_Hmass", &AZH_Hmass, &b_AZH_Hmass);
   ...
   fChain->SetBranchAddress("AZH_ChiSquare", &AZH_ChiSquare, &b_AZH_ChiSquare);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do", &LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do);
   fChain->SetBranchAddress("SFweight4l", &SFweight4l, &b_SFweight4l);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do", &LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do", &LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Do);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90__Up", &LepSF3l__ele_mvaFall17V2Iso_WP90__Up, &b_LepSF3l__ele_mvaFall17V2Iso_WP90__Up);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW", &LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Up", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Up, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Up);
   ...
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90__Do", &LepSF4l__ele_mvaFall17V2Iso_WP90__Do, &b_LepSF4l__ele_mvaFall17V2Iso_WP90__Do);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Do", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Do, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__Do);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW", &LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90__Up", &LepSF4l__ele_mvaFall17V2Iso_WP90__Up, &b_LepSF4l__ele_mvaFall17V2Iso_WP90__Up);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80", &LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Do", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Do, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Do);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Up", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Up, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__Up);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80", &LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW", &LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90__Do", &LepSF3l__ele_mvaFall17V2Iso_WP90__Do, &b_LepSF3l__ele_mvaFall17V2Iso_WP90__Do);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW", &LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW, &b_LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up", &LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Do", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Do, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Do);
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW", &LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW, &b_LepSF3l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Up", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Up, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS__Up);
   fChain->SetBranchAddress("LepSF4l__mu_cut_Tight_HWWW__Do", &LepSF4l__mu_cut_Tight_HWWW__Do, &b_LepSF4l__mu_cut_Tight_HWWW__Do);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW", &LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW, &b_LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80", &LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90__Do", &LepSF2l__ele_mvaFall17V2Iso_WP90__Do, &b_LepSF2l__ele_mvaFall17V2Iso_WP90__Do);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up", &LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Up);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80", &LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80);
   fChain->SetBranchAddress("LepSF2l__mu_cut_Tight_HWWW__Do", &LepSF2l__mu_cut_Tight_HWWW__Do, &b_LepSF2l__mu_cut_Tight_HWWW__Do);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__Do);
   ...
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up", &LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up);
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90__Up", &LepSF2l__ele_mvaFall17V2Iso_WP90__Up, &b_LepSF2l__ele_mvaFall17V2Iso_WP90__Up);
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up", &LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up, &b_LepSF4l__ele_mvaFall17V2Iso_WP90_tthmva_70__Up);
   ...
   fChain->SetBranchAddress("LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80", &LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF4l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW", &LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_SS_tthmva_70__mu_cut_Tight_HWWW);
   ...
   fChain->SetBranchAddress("LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80", &LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80, &b_LepSF2l__ele_mvaFall17V2Iso_WP90_tthmva_70__mu_cut_Tight_HWWW_tthmva_80);
   ...
   fChain->SetBranchAddress("LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW", &LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW, &b_LepSF3l__ele_mvaFall17V2Iso_WP90_SS__mu_cut_Tight_HWWW);
